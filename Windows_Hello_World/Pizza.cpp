...
void DeliveryControls(HWND pizza) {
	...
	hwndRadio1 = CreateWindowW(L"Button", L"30см", WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON | WS_TABSTOP | DT_CENTER,
		10, 160, 100, 23, pizza, (HMENU)CMD_RADIO_BUTTON1, hInstPizza, 0);
	hwndRadio2 = CreateWindowW(L"Button", L"40см", WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON | WS_TABSTOP | DT_CENTER,
		10, 190, 100, 23, pizza, (HMENU)CMD_RADIO_BUTTON2, hInstPizza, 0);
	hwndRadio3 = CreateWindowW(L"Button", L"50см", WS_CHILD | WS_VISIBLE | BS_RADIOBUTTON | WS_TABSTOP | DT_CENTER,
